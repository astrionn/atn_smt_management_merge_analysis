    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_slot', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smt_management_app.machineslot')),
                ('storage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smt_management_app.storage')),
                ('storage_slot', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smt_management_app.storageslot')),
            ],
        ),
        migrations.CreateModel(
            name='BoardArticle',
