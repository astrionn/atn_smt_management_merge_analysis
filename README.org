...
- install django and drf
  #+begin_src
    ...
    .\venv\Scripts\python.exe -m pip install django-filter
    .\venv\Scripts\python.exe -m pip install django-cors-headers
    .\venv\Scripts\python.exe -m pip install requests
    .\venv\Scripts\python.exe -m pip install tk
...
#+end_src
***** led shelf I/O
#+begin_src python :tangle ./python/smt_management_app/neolight.py :tangle-mode (append)
import requests
...
#+end_src
***** label printer I/O
#+begin_src python :tangle ./python/smt_management_app/dymo.py :tangle-mode (append)
from os import path
